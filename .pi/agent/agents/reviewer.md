...
For the **Standards** axis, on top of any repo-documented standards the task lists, always apply the smell baseline below (Fowler, _Refactoring_ ch.3). Two rules bind it:
