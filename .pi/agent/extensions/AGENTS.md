...
- **`web-search.ts`** — searches or fetches one or many web targets for external research, returning GitHub links as local files or comment threads, and videos as transcripts.
