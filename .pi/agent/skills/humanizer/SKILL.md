---
name: humanizer
description: Rewrite AI-sounding prose so it reads like the writer, without changing what it says.
...
Upstream skill: [blader/humanizer](https://github.com/blader/humanizer/blob/main/SKILL.md), version 3.0.0, MIT. The patterns come from Wikipedia's ["Signs of AI writing"](https://en.wikipedia.org/wiki/Wikipedia:Signs_of_AI_writing), maintained by WikiProject AI Cleanup, and from reviews of AI-generated text on Wikipedia and elsewhere.
